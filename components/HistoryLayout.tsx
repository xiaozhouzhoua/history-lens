      ...
      <div className="max-w-6xl mx-auto px-4 py-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6">
          ...
          <div className="bg-white rounded-lg border border-[#E6E2D6] overflow-hidden">
            ...
            {/* 图片区域 */}
            <div className="relative w-full aspect-[16/9] bg-[#F7F5EF] border-b border-[#E6E2D6]">
              {loadingImage && !imageUrl ? (
                ...
                <img src={imageUrl} alt={data.visualPrompt} className="w-full h-full object-contain p-4" />
              ) : (
